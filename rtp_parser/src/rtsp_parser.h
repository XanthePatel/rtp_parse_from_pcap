#ifndef __RTSP_PARSE__
#define __RTSP_PARSE__
...
public:
	...
	static rtsp_parser* instance(unsigned int src_ip, unsigned short src_port, unsigned int dst_ip, unsigned short dst_port);
...
private:
	...
	//src_ip and  dst_ip should be network byte order
	//src_port and dst_port should be  host byte order
	rtsp_parser(unsigned int src_ip, unsigned short src_port, unsigned int dst_ip, unsigned short dst_port);
	~rtsp_parser();
...
private:
	...
	typedef std::map< multi_key, rtsp_parser* > stream_map;
